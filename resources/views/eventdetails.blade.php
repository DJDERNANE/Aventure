                ...
                <header>
                    <div class="mil-hero-3">
                        ...
                        <div class="container">
                            ...
                            <div class="row justify-content-between align-items-center" style="padding-bottom: 40px; font-size: 20px">
                                ...
                                <div class="mil-12 col-xl-6 mil-mb-120">
                                    ...
                                    <div class="mil-collage-1">
                                        ...
                                        <div class="mil-image-1 mil-appearance">
                                            <div>
                                                <img src="http://127.0.0.1:8000/pictures/events/{{ $event->photo }}" alt="event" width="400" height="400">  </div>
                                        </div>
