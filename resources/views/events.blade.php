...
<head>
    ...
    <style>
        ...
        .floor button {
            background-color: rgb(240, 130, 27);
            color: white;
            border: none;
            border-radius: 20px;
            font-size: 20px;
                ...
                <div class="content">
                    <div class="container">
                        <div>
                            ...
                            <h3 class="mil-appearance mil-mb-20">We’ve Organized</h3>
                            <h5 class="mil-mb-20">Variant Events our commitment was to create the best spot for Startups
                                to work and show off.</h5>
                            <div class="cards row">
                                @foreach ($eventsOrganized as $item)
                        ...
                        <div>
                            <div class="header-event">
                                <h3 class="mil-appearance mil-mb-30">We Took Part At</h3>
                                <div class="btns">
                            ...
                            <h5>Diffrent local and international events and cermony, representing our ecosystem</h5>
                            <div class="swiper mySwiper">
                                <div class="swiper-wrapper">
                                    @foreach ($eventsTookPart as $item)
